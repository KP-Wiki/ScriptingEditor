...
type
  TGutterPainEvent = procedure(aCanvas: TCanvas; const aClip: TRect; aFirstLine, aLastLine: Integer) of object;
  ...
  protected
    procedure AfterPaint(aCanvas: TCanvas; const aClip: TRect; aFirstLine, aLastLine: Integer); override;
...
procedure TSEValidationPlugin.AfterPaint(aCanvas: TCanvas; const aClip: TRect; aFirstLine, aLastLine: Integer);
begin
